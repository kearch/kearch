...
<html>
  <head>
    <title>kearch meta search engine front API</title>
    <style type="text/css">
      body {
...
.method-tag {
  ...
  <body>
  <h1>kearch meta search engine front API</h1>
    <div class="app-desc">kearch meta search engine front API</div>
    ...
    <div class="app-desc">BasePath:/me/front</div>
  ...
  <ul>
  <li><a href="#searchGet"><code><span class="http-method">get</span> /search</code></a></li>
  </ul>

  <h1><a name="Default">Default</a></h1>
  <div class="method"><a name="searchGet"/>
    <div class="method-path">
    <a class="up" href="#__Methods">Up</a>
    <pre class="get"><code class="huge"><span class="http-method">get</span> /search</code></pre></div>
    <div class="method-summary"> (<span class="nickname">searchGet</span>)</div>
    ...
    <div class="field-items">
      ...
      <div class="param-desc"><span class="param-type">Query Parameter</span> &mdash;  default: null </div><div class="param">sp (optional)</div>
