...
<html>
  <head>
    <title>kearch specialist search engine front API</title>
    <style type="text/css">
      body {
...
.method-tag {
  ...
  <body>
  <h1>kearch specialist search engine front API</h1>
    <div class="app-desc">kearch specialist search engine front API</div>
    ...
    <div class="app-desc">BasePath:/sp/front</div>
