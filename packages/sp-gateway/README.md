...
<html>
  <head>
    <title>kearch specialist search engine gateway API</title>
    <style type="text/css">
      body {
...
.method-tag {
  ...
  <body>
  <h1>kearch specialist search engine gateway API</h1>
    <div class="app-desc">kearch specialist search engine gateway API</div>
    ...
    <div class="app-desc">BasePath:/v0/sp/gateway</div>
  ...
  <li><a href="#getASummaryGet"><code><span class="http-method">get</span> /get_a_summary</code></a></li>
  ...
  <div class="method"><a name="addAConnectionRequestPost"/>
    ...
    <div class="method-summary">Add a connection request sent from meta server to specialist server. (<span class="nickname">addAConnectionRequestPost</span>)</div>
    ...
    <div class="field-items">
      <div class="param">ConnectionRequestOnSP <a href="#ConnectionRequestOnSP">ConnectionRequestOnSP</a> (required)</div>
  ...
  "me_host" : "me_host"
    ...
    An info about the meta server that requested the connection.
        <a href="#inline_response_200">inline_response_200</a>
  </div> <!-- method -->
  <hr/>
  <div class="method"><a name="deleteAConnectionRequestDelete"/>
    ...
    <div class="method-summary">Delete a connection request sent from meta server to specialist server. (<span class="nickname">deleteAConnectionRequestDelete</span>)</div>
    <div class="method-notes"></div>
    ...
    <div class="field-items">
      <div class="param">me_host (optional)</div>

      <div class="param-desc"><span class="param-type">Query Parameter</span> &mdash; A meta host name of the connection request to delete. default: null </div>
    </div>  <!-- field-items -->
  ...
  <hr/>
  <div class="method"><a name="getASummaryGet"/>
    <div class="method-path">
    <a class="up" href="#__Methods">Up</a>
    <pre class="get"><code class="huge"><span class="http-method">get</span> /get_a_summary</code></pre></div>
    <div class="method-summary">Get summary of this specialist server. (<span class="nickname">getASummaryGet</span>)</div>
    <div class="method-notes"></div>
    ...
    <div class="field-items">
      ...
      <div class="param-desc"><span class="param-type">Query Parameter</span> &mdash; A host name of the meta server. default: null </div>
    </div>  <!-- field-items -->
  ...
  "sp_host" : "sp_host"
    ...
    <h3 class="field-label">Responses</h3>
    <h4 class="field-label">200</h4>
    A summary of this specialist server.
        <a href="#Summary">Summary</a>
  </div> <!-- method -->
  <hr/>
  <div class="method"><a name="retrieveGet"/>
    ...
    <div class="field-items">
      ...
      <div class="param-desc"><span class="param-type">Query Parameter</span> &mdash; Max number of URLs to retrive from specialist servers default: null format: int32</div>
    </div>  <!-- field-items -->
  ...
  <h3>Table of Contents</h3>
  <ol>
    <li><a href="#ConnectionRequestOnSP"><code>ConnectionRequestOnSP</code> - </a></li>
  ...
  <div class="model">
    <h3><a name="ConnectionRequestOnSP"><code>ConnectionRequestOnSP</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">meUnderscorehost (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span>  </div>
